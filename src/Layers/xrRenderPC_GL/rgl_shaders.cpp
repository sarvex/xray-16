    ...
    pcstr pTarget, u32 Flags, void*& result)
{
    ...
    GLuint program = 0;
    if (false && HW.ShaderBinarySupported && HW.SeparateShaderObjectsSupported && FS.exist(full_path))
    {
    ...
    if (!program)
    {
        ...
        EShMessages messages = (EShMessages)(EShMsgRelaxedErrors | EShMsgReadHlsl | EShMsgHlslOffsets | EShMsgHlslLegalization | /*EShMsgHlslDX9Compatible |*/ EShMsgEnhanced);
